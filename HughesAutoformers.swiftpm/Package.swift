...
var package = Package(
    ...
    products: [
        .iOSApplication(
            name: "HughesAutoformersApp",
            targets: ["AppModule"],
            bundleIdentifier: "com.colemancda.HughesAutoformers",
    ...
    dependencies: [
        .package(url: "https://github.com/MillerTechnologyPeru/HughesAutoformers.git", "0.1.0"..<"1.0.0"),
    ...
    targets: [
        .executableTarget(
            name: "AppModule",
            dependencies: [
                .product(name: "HughesAutoformers", package: "HughesAutoformers"),
